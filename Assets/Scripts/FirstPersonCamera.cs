...
public class FirstPersonCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Keep the player's x rotation clamped to [-90, 90]
        xRot = Mathf.Clamp(xRot, -90f, 90f);

        // Rotation the camera around the x-axis
    ...
    {
        // Reading the mouse deltas as a vector 2 (delta X is the x compnent and deslta y is the y component)
